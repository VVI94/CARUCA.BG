<%@ include file="header.jsp" %>
 ...
 <td style="width:60%;" align="center"> 		
	...
	ResultSet rs = dbm.ExecuteResultSet("SELECT name FROM categories WHERE id='"+request.getParameter("catId")+"'");
	rs.first();
	String catName = rs.getString("name");
	sb.append("<h1>Caruca Offers For "+catName.toUpperCase()+"</h1><table cellpadding='15'>");
	rs = dbm.ExecuteResultSet("SELECT * FROM cars WHERE category_id='"+request.getParameter("catId")+"'");
			if (rs.isBeforeFirst()) {
				while (rs.next()) {
